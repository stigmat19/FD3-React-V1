...
var clientsArr = [{ id: 101, fio: "Иванов И.И.", balance: 20 }, { id: 105, fio: "Сидоров С.С.", balance: 2 }, { id: 110, fio: "Петров П.П.", balance: 180 }, { id: 120, fio: "Григорьев Г.Г.", balance: 220 }];
...
var _MobileClient = __webpack_require__(34);
...
var MobileCompany = function (_React$Component) {
  _inherits(MobileCompany, _React$Component);
  ...
  function MobileCompany() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MobileCompany.__proto__ || Object.getPrototypeOf(MobileCompany)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      return !((0, _deepEqual2.default)(newProps, _this.props) && (0, _deepEqual2.default)(newState, _this.state));
    }, _this.setName1 = function () {
      _this.setState({ name: 'МТС' });
    }, _this.setName2 = function () {
      _this.setState({ name: 'Velcom' });
    }, _this.updateBalance = function (clientId, delta) {
      var newClients = _this.state.clients.map(function (client) {
        var newClient = _extends({}, client);
        if (newClient.id == clientId) newClient.balance += delta;
        return newClient;
      });
      _this.setState({ clients: newClients });
    }, _this.updateBalance1 = function () {
      _this.updateBalance(105, -1);
    }, _this.updateBalance2 = function () {
      _this.updateBalance(105, 1);
  ...
  _createClass(MobileCompany, [{
    ...
    value: function render() {
      ...
      var clientsCode = this.state.clients.map(function (c) {
        return _react2.default.createElement(_MobileClient2.default, { key: c.id, id: c.id, fio: c.fio, balance: c.balance });
      });
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', { type: 'button', value: '\u0421\u0438\u0434\u043E\u0440\u043E\u0432--', onClick: this.updateBalance1 }),
        _react2.default.createElement('input', { type: 'button', value: '\u0421\u0438\u0434\u043E\u0440\u043E\u0432++', onClick: this.updateBalance2 })
      );
    }
  }]);
...
var MobileClient = function (_React$Component) {
  _inherits(MobileClient, _React$Component);
  ...
  function MobileClient() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MobileClient.__proto__ || Object.getPrototypeOf(MobileClient)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      _this.setState({ balance: newProps.balance });
    }, _this.shouldComponentUpdate = function (newProps, newState) {
      var oldActive = _this.state.balance >= 0;
      var newActive = newState.balance >= 0;
      return newProps.fio != _this.props.fio || oldActive != newActive;
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        this.state.balance >= 0 ? _react2.default.createElement(
          'span',
          { className: 'MobileClientBalance MobileClientBalanceActive' },
          '\u0430\u043A\u043A\u0430\u0443\u043D\u0442 \u0430\u043A\u0442\u0438\u0432\u0435\u043D'
        ) : _react2.default.createElement(
          'span',
          { className: 'MobileClientBalance MobileClientBalanceBlocked' },
          '\u0430\u043A\u043A\u0430\u0443\u043D\u0442 \u0431\u043B\u043E\u043A\u0438\u0440\u043E\u0432\u0430\u043D'
        ),
        _react2.default.createElement(
          'span',
